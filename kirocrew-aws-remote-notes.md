...
Diagram and source-link baseline: verified September 11 nightly. The local rehearsal uses the separately fingerprinted user-installed September 12 nightly; see continuation evidence. Build: `0.7.0.dev20260911060948`; commit `fa0d8cf3c241b3b53b81fe4115ab70a30c1ca482`.
...
## Historical AWS walkthrough (retained; current evidence is in the continuation section)
